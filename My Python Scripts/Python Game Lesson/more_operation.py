...
width = 800				# the width of the game canvas
position = 797			# the horizontal position
move = 5				# the horizontal movement of the ship
position = (position + move) % width	# when the ship moves out of range, % allows it to reappear on the other side

print position

position = 2			# another horizontal position
move = -5				# movement in negative direction
position = (position + move) % width	# negative direction movement
