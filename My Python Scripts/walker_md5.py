...
for drive in allDrives:
    try:
        ...
        print "Cannot process drive %s due to %s - this is expected" %(drive, e)
        print
        continue
#
    ...
    for root, dirs, files in os.walk(path):
        for fileName in files:
            ...
            if "Error" not in hash:
                ...
                print "Cannot process:", fullFile, hash
                print "The above is most probably normal and expected due to permissions."
                print "The program will continue to execute."
                print
...
print
print "Writing the output to the file named %s in the current directory" % output
print
